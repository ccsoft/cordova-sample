...
##Versions
Sample app is built and tested with Cordova 3.6.3 (Android) and we only support Cordova version > 3.0.
...
>####example
	...
	plugin.graphCall("me", {"fields": "name"}, "GET", function(resp) {
           console.log("My name is: " + resp);
       }		
	}, failureCallback);
